...
uint256 hashGenesisBlock("0xcee401ae2a8f24ab33ca089f685ce1ffbc145e492e2bb2bb0a8757e12f3f1d5c");
...
int64 nChainStartTime = 1393983056;
...
bool LoadBlockIndex()
{
    ...
    {        
        ...
        pchMessageStart[2] = 'u';
        pchMessageStart[3] = 's';
        hashGenesisBlock = uint256("0xf15a474813c905ee878ddcca8a474540f1a8fbc1a04c2264f2fa98ac784ccc46");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "March 2014 Reign of the EMUs begin ahahaha";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce = 1101807;
        block.nTime = 1393983056;
        
        if (fTestNet)
        {

            block.nNonce = 176854;
            block.nTime = 1393982075;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0a56cbdcc2a7e0aee9371213dba7a44700b3faed9acd80f6a637f909fa4c9a82"));
